...
<script>
import { getList } from '@/api/service/product'
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.tipsShow = false
      this.$emit('update-product', this.moreList, this.remark ? 'productList' : 'product')
      this.drawer = false
    },
    // 改变分页数
