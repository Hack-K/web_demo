...
module.exports = {
  ...
  chainWebpack(config) {
    ...
    config.when(['production','development',].includes(process.env.NODE_ENV), (config) => {
      ...
      sass: {
        ...
        additionalData(content, loaderContext) {
          ...
          if (
            ...
            'src/assets/styles/variables/variables.scss'
          )
            return (
              '@use "sass:math";@import "~@/assets/styles/variables/variables.scss";' +
              content
            )
          return content
        },
